...
{
    /// <summary>
    /// This classes exposes methods used by CognitoAWSCredentials to cache the 
        ...
        private static void SetupDatabase(string dataPath)
        {
            lock (SQLiteDatabase.SQLiteLock)
            {
                ...
                try
                {
                    ...
                    db = new SQLiteDatabase(System.IO.Path.Combine(AmazonHookedPlatformInfo.Instance.PersistentDataPath, dataPath));
